...
\begin{tikzpicture}[node distance = 2cm, auto]
    % Place nodes
    \node [block] (init) {Select initial state (i.e {\tt FERRO} or {\tt PREV}) and select Hamiltonian.};
    ...
    \langle \mathcal{O} \rangle \rightarrow \langle \mathcal{O} \rangle + \frac{\mathcal{O}}{{\tt ensemble\_size}}  
     \end{equation}};
...
Guo, Ruyan
Bhalla, Amar S,
Ferroelectrics, , 382:28?35, 2009

\bibitem{nonCentro}
X. Zhu, N. Mercier, A. Riou, P. Blanchard, P. Fr\'{e}re, 
Chem. Commun., 2160-2161 (2002).

\bibitem{VASP1}
 G. Kresse and J. Haffner, Phys. Rev. B {\bf 47}, 558 (1993).

\bibitem{VASP2}
 G. Kresse and J. Furthm\"{u}ller, Computational Materials
Science {\bf 6}, 15 (1996).
...
%\bibitem{PAW}
%P. E. Bl\"{o}chl, Physical Review B {\bf 50}, 17953 (1994).

\bibitem{Amplimodes1}
 D. Orobengoa, C. Capillas, M. I. Aroyo, and J. M. Perez-
Mato, J. App. Cryst. {\bf 42}, 820 (2009)

\bibitem{Amplimodes2}
 J. Perez-Mato, D. Orobengoa, and M. Aroyo, Acta Cryst. A {\bf 66}, 558 (2010).
