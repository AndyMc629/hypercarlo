...
plt.axvline(x=cvmaxT,ymin=0,ymax=1,linestyle='--', color='red', label=r'$C_v^{max}$ ('+str(int(cvmaxT)) +'K)')
plt.legend(loc='upper right', numpoints=1)
...
plt.axvline(x=chimaxT,ymin=0,ymax=1,linestyle='--', color='red', label=r'$\chi^{max}$ ('+str(int(chimaxT)) +'K)')
plt.legend(loc='upper right', numpoints=1)
